...
**What  I learned** How to structure an HTML page and how to incorpertate, unordered lists, tables, links, and nav bars.
**Challenges** I had a little troble getting the nav bar to work for the Index page from the hobby page. And I had to refresh my self on how to incorperate style in HTML. 
